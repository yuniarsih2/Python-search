# Temukan element yang sering muncul paling banyak dalam sebuah list yang sudah diurutkan
...
my_list = [2, 2, 2, 4, 4, 4, 6, 6, 6, 6, 8, 8, 8, 8, 8,]
...
# Output Element yang paling sering muncul adalah 6
